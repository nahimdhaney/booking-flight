...
export class PassangerServices {
  ...
  async createPassanger(createPassangerDto: PassangerDto): Promise<Passanger> {
    ...
    const passanger = this.passangerFactoryService.createNewPassanger(createPassangerDto);

    const createdPassanger = await this.dataServices.passanger.create(passanger);
  ...
  updatePassanger(
    ...
    const passanger = this.passangerFactoryService.updatePassanger(updatePassangerDto);
